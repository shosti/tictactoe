...
get the app created:
    ...
    $ heroku apps:create tictactoe
    Creating tictactoe... done, stack is cedar
    http://tictactoe.herokuapp.com/ | git@heroku.com:tictactoe.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://tictactoe.herokuapp.com deployed to Heroku

    To git@heroku.com:tictactoe.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://tictactoe.herokuap.com
    ["Hello" :from Heroku]
